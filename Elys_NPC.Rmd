...
urlcolor: blue
fontsize: 12pt
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file = file.path("report", paste0(Sys.Date(), "_Elys.Chip-seq.Capelson.NPC.pdf"))) })
---
...
# 2. Genes with promoters residing inside Elys peaks defined above
