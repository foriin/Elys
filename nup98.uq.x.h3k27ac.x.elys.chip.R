...
seqlevels(h3k27ac.hmm3, pruning.mode = "coarse") <- chroms
seqlevels(elys.emb.hmm3, pruning.mode = "coarse") <- chroms
...
nup.npc.x.h3k27ac <- sum(width(GenomicRanges::intersect(nup98.npc.hmm3.uq, h3k27ac.hmm3, ignore.strand = T)))
nup.nuc.x.h3k27ac <- sum(width(GenomicRanges::intersect(nup98.nuc.hmm3.uq, h3k27ac.hmm3, ignore.strand = T)))

nup.npc.x.h3k27ac.pv <- perm.test.length(nup98.npc.hmm3.uq,
                                         h3k27ac.hmm3,
...
nup.nuc.x.h3k27ac.pv <- perm.test.length(nup98.nuc.hmm3.uq,
                                         h3k27ac.hmm3,
                                         contr.val = nup.nuc.x.h3k27ac)
ndom.overlap(nup98.nuc.hmm3.uq, h3k27ac.hmm3)
...
nup98.x.h3k27ac.df <- data.frame(NPC = c(nup.npc.x.h3k27ac,
                                         ...
                                         nup.npc.x.h3k27ac/sum(width(nup98.npc.hmm3.uq))),
                                 NUC = c(nup.nuc.x.h3k27ac,
                                         nup.nuc.x.h3k27ac/sum(width(h3k27ac.hmm3)),
                                         nup.nuc.x.h3k27ac/sum(width(nup98.nuc.hmm3.uq))),
...
nup98.x.h3k27ac.df.2 <- tibble(NUP = c("NPC*", "NUC*"),
                                   ...
                                   ix = c(nup.npc.x.h3k27ac,
                                          nup.nuc.x.h3k27ac),
                                   `%NUP length` = c(nup.npc.x.h3k27ac/sum(width(nup98.npc.hmm3.uq)),
                                              nup.nuc.x.h3k27ac/sum(width(nup98.nuc.hmm3.uq))),
                                   `%Interact length` = c(nup.npc.x.h3k27ac/sum(width(h3k27ac.hmm3)),
                                                   nup.nuc.x.h3k27ac/sum(width(h3k27ac.hmm3))),
                                   p.v.width = c(nup.npc.x.h3k27ac.pv,
                                                 nup.nuc.x.h3k27ac.pv)
) %>% cbind(rbind(ndom.overlap(nup98.npc.hmm3.uq, h3k27ac.hmm3),
                  ndom.overlap(nup98.nuc.hmm3.uq, h3k27ac.hmm3)) %>% 
...
e.elys.x.nup.npc <- sum(width(GenomicRanges::intersect(elys.emb.hmm3,
                                                       nup98.npc.hmm3.uq,
                                                       ignore.strand = T)))
e.elys.x.nup.nuc <- sum(width(GenomicRanges::intersect(elys.emb.hmm3,
                                                       nup98.nuc.hmm3.uq,
                                                       ignore.strand = T)))
e.elys.x.nup.npc.pv <- perm.test.length(elys.emb.hmm3,
                                        nup98.npc.hmm3.uq,
                                        contr.val = e.elys.x.nup.npc)
# e.elys.x.nup.npc.pv.jac <- perm.test.jac(elys.emb.hmm3,
                                        # nup98.npc.hmm3.uq)
e.elys.x.nup.nuc.pv <- perm.test.length(elys.emb.hmm3,
                                        nup98.nuc.hmm3.uq,
...
# e.elys.x.nup.nuc.2.pv.jac <- perm.test.jac(elys.emb.hmm.x,
                                          # nup98.nuc.hmm3.uq)
elys.x.nup.uq.df <- tibble(Tissue = rep(c("S2", "Embryo", "Embryo"), each = 2),
                        HMM3 = rep(c("NA", "merged", "by each rep"),each = 2),
                        NUP = rep(c("NPC*", "NUC*"), 3),
                        ix = c(elys.x.nup.npc,
                               elys.x.nup.nuc,
                               e.elys.x.nup.npc,
                               ...
                               e.elys.x.nup.npc.2, 
                               e.elys.x.nup.nuc.2),
                        `%NUP length` = c(elys.x.nup.npc/sum(width(nup98.npc.hmm3.uq)),
                                   elys.x.nup.nuc/sum(width(nup98.nuc.hmm3.uq)),
                                   e.elys.x.nup.npc/sum(width(nup98.npc.hmm3.uq)),
                                   e.elys.x.nup.nuc/sum(width(nup98.nuc.hmm3.uq)),
                                   e.elys.x.nup.npc.2/sum(width(nup98.npc.hmm3.uq)),
                                   e.elys.x.nup.nuc.2/sum(width(nup98.nuc.hmm3.uq))),
                        `%Elys length` = c(elys.x.nup.npc/sum(width(s2.chip.bed)),
                                    elys.x.nup.nuc/sum(width(s2.chip.bed)),
                                    e.elys.x.nup.npc/sum(width(elys.emb.hmm3)),
                                    e.elys.x.nup.nuc/sum(width(elys.emb.hmm3)),
                        ...
                        p.v.width = c(elys.x.nup.npc.pv,
                          ...
                          cbind(rbind(
                            ndom.overlap(nup98.npc.hmm3.uq, s2.chip.bed),
                            ndom.overlap(nup98.nuc.hmm3.uq, s2.chip.bed),
                            ndom.overlap(nup98.npc.hmm3.uq, elys.emb.hmm3),
                            ndom.overlap(nup98.nuc.hmm3.uq, elys.emb.hmm3),
                            ndom.overlap(nup98.npc.hmm3.uq, elys.emb.hmm.x),
                            ndom.overlap(nup98.nuc.hmm3.uq, elys.emb.hmm.x)
